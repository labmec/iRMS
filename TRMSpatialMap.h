...
public:
    ...
    TRMSpatialMap(int matid);
    
    /** @brief Constructor based on a material id and dimension */
    ...
    virtual int Dimension() const override {return fdimension;}
...
//    virtual TPZMaterial * NewMaterial()  override { return new TPZElasticityMaterial(*this);}
    ...
    virtual int GetIntegrationOrder(TPZVec<int> &porder_left, TPZVec<int> &porder_right) const override {
        return 0;
    }
