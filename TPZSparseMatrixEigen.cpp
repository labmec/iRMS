...
void TPZSparseMatrixAT_Eigen::AssembleMassParallel(){
...
void TPZSparseMatrixAT_Eigen::AssembleParallel(){
    int n_cells = fAlgebraicTransport->fCellsData.fVolume.size();
...
void TPZSparseMatrixAT_Eigen::AnalyzePattern(){
    AssembleMassParallel();
    AssembleParallel();
...
void TPZSparseMatrixAT_Eigen::Solve(){
    m_transmissibility += m_mass;
    m_rhs *= -1.0;
